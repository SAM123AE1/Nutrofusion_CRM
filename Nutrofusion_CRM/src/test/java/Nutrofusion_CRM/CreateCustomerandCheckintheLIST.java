...
public class CreateCustomerandCheckintheLIST extends BaseTestforRealProject {

	@Test(groups = "smoke")
	public void CustomerLISTcheckTest() throws Throwable {
		...
		hp.Conatctlink().click();
		pluscon.selectbyln(LastName);

		
		UtilityclassObject.getTest().log(Status.INFO, " verify customer information");

		String listtextln = driver.findElement(By.xpath("//a[.='"+LastName+"']")).getText();

		

		hardobj.hardAssertforboolean(LastName, listtextln);
