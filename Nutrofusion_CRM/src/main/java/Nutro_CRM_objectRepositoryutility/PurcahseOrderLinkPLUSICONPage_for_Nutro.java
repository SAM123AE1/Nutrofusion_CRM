...
public class PurcahseOrderLinkPLUSICONPage_for_Nutro  {
	WebDriver driver;

	public PurcahseOrderLinkPLUSICONPage_for_Nutro(WebDriver driver) {
		this.driver = driver;
	...
	private WebElement createNewPurchasebtn;

	

	
	public WebElement getcreateNewPurchasebtn() {
		return createNewPurchasebtn;
	}
