...
public class ContactLinkPLUSICONPage_for_Nutro  {
	WebDriver driver;

	public ContactLinkPLUSICONPage_for_Nutro(WebDriver driver) {
		this.driver = driver;
...
//	private WebElement selectbyln;
	
//	public WebElement getSelectbyln() {
//		
//		return selectbyln;
//	}
public void selectbyln(String ln)
{
